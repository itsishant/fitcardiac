...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-b from-secondary-gray to-gray-900 text-white relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
            ...
            >
              <Link href="/" className="flex items-center mb-4 group">
                ...
                <span className="text-2xl font-bold leading-tight">
                  <span className="block bg-gradient-to-r from-primary-teal to-red-500 bg-clip-text text-transparent">
                    FIT CARDIAC
                  </span>
              ...
              <p className="text-gray-300 mb-6 max-w-md">
                FIT CARDIAC DIAGNOSTIC CENTRE is a fully digital cardiac imaging
                and stress testing centre in Canada. We offer echocardiogram,
                ECG, Holter monitor, stress echo, stress test, and ambulatory BP
                monitoring with fast report turnaround.
              </p>
              <div className="space-y-3">
                <div className="flex items-start gap-3 text-gray-300">
                  <MapPin className="w-5 h-5 text-primary-teal mt-1 flex-shrink-0" />
                  <span>
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            >
              © {new Date().getFullYear()} FIT CARDIAC DIAGNOSTIC CENTRE. All
              rights reserved.
            </motion.p>
            <motion.div
              initial={{ opacity: 0 }}
