...
export default function Testimonials() {
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary-green-light via-white to-primary-green-light/30 relative overflow-hidden">
      {/* Decorative Elements */}
      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-secondary-gray mb-4">
            What Our <span className="text-primary-teal">Patients Say</span>
          </h2>
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-bold text-secondary-gray">{testimonial.name}</h4>
                  <p className="text-sm text-secondary-gray-light">{testimonial.role}</p>
                </div>
              </div>
            </motion.div>
          ))}
