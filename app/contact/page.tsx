            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-1 space-y-6">
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-secondary-gray mb-2">
                    Fax
                  </h3>
                  <p className="text-secondary-gray-light mb-2">
                    For referrals & documents
                  </p>
                ...
                >
                  ...
                  <a
                    ...
                    className="text-primary-teal hover:text-primary-teal-dark font-semibold"
                  >
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-3xl font-bold text-secondary-gray">
                    Send us a Message
                  </h2>
                </div>
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label
                        htmlFor="name"
                        className="block text-sm font-semibold text-secondary-gray mb-2"
                      >
                        Full Name *
                      </label>
                      <input
                  ...
                  <motion.button
                    ...
                    className={`w-full px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-200 shadow-lg flex items-center justify-center gap-2 ${
                      isSubmitting
                        ? "bg-gray-400 cursor-not-allowed"
                        : "bg-primary-teal text-white hover:bg-primary-teal-dark"
                    }`}
                  >
                    {isSubmitting ? (
                      <>
